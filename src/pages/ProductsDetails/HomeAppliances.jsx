...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 mx-auto gap-8 justify-items-center p-4 mt-75 sm:mt-50 md:mt-48 lg:mt-48 xl:mt-48 overflow-y-auto h-[100%] py-10 scrollbar-hide">        {homeAppliances.map((product, idx) => (
