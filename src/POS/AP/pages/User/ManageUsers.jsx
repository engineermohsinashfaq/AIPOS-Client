...
export default function ManageUsers() {
  ...
  const [password, setPassword] = useState("zubi@pakistani"); // static password

  const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false);
  const [userToDelete, setUserToDelete] = useState(null);

  const [isSaveConfirmOpen, setIsSaveConfirmOpen] = useState(false);
  const [pendingForm, setPendingForm] = useState(null); // holds form data for save confirmation
  ...
  function getNextId(prevUsers) {
    if (prevUsers.length === 0) return "01";
    const nums = prevUsers.map((u) => parseInt(u.id)).filter(Boolean);
  ...
  // Handle save: open confirmation modal
  ...
  function handleSaveConfirm() {
    ...
    if (editing) {
      ...
      notifySuccess(
        `${userData.firstName} ${userData.lastName} has been added.`
      );
    }
    ...
    <div className="p-2 min-h-screen text-black">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-white/80">Add, edit, view and remove users.</p>
        </div>
        ...
        <div className="flex justify-between items-center">
          <button
            ...
            className="inline-flex items-center gap-2 bg-cyan-800/80 hover:bg-cyan-900 backdrop-blur-lg border border-white/20 text-white px-4 py-2 rounded-md transition"
          >
          ...
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg p-6 w-full max-w-lg text-white">
            ...
            <form onSubmit={handleSave} className="space-y-3">
              ...
              <div className="mt-2 text-white/80">
                <p>
                  <strong>Username:</strong> {form.cnic || "—"}
                </p>
                <p>
      ...
      {isSaveConfirmOpen && pendingForm && (
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg p-6 w-full max-w-sm text-white">
            ...
            <p className="mb-4">
              Are you sure you want to {editing ? "update" : "save"} the user{" "}
              <strong>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg p-6 w-full max-w-lg text-white">
            ...
            <div className="space-y-2">
              ...
              <p>
                <strong>Username:</strong> {selectedUser.cnic}
              </p>
              <p>
                <strong>Password:</strong> zubi@pakistani
              </p>
              <p>
