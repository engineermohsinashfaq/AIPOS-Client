...
export default function AddAdmin() {
  ...
  return (
    <div className="flex items-center justify-center h-[100%] text-white p-4">
      {/* ✅ Dark Theme Toasts with 2-second duration */}
      <ToastContainer theme="dark" autoClose={2000} />

      <div className="w-7xl bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-xl">
