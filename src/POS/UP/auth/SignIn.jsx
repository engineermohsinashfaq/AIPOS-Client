  ...
  return (
    <>
      ...
      >
        ...
        <motion.div className="max-w-sm w-full mx-4 relative" variants={cardVariant}>
          <motion.div
          ...
          >
            ...
            <motion.div className="text-center mb-4" variants={fadeInUp}>
              ...
              <motion.h1 className="text-2xl font-bold text-white mb-1" variants={fadeInUp}>
                Zubi Electronics
              </motion.h1>
            ...
            {/* Sign In Form */}
            <motion.form onSubmit={handleSubmit} className="space-y-2" variants={staggerContainer}>
              {error && (
                <motion.div
              ...
              <motion.div variants={fadeInUp}>
                <label className="block text-white font-medium mb-1 text-sm">CNIC</label>
                <input
                  type="text"
                  value={cnic}
              ...
              <motion.div className="flex items-center justify-between" variants={fadeInUp}>
                <Link to="/forgot-password" className="text-white/80 hover:text-white text-xs transition-colors mb-3">
                  Forgot Password?
                </Link>
              </motion.div>
